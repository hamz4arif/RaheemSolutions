  ...
  <form action="{{ url('/ticket/save', [])  }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-row ">
      <div class="col-md-8 mb-3 ">
        ...
        <input type="text" {{$model->user_id && $model->user_id!=$currentuser?"disabled":""}} class=" textbox form-control" id="validationDefault04" value="{{$model->subject}}" placeholder="Title" name="subject">
      </div>
      <div class="col-md-4 mb-3 ">
        <div class="form-group ">
          <label for="exampleFormControlSelect1">Assign to(staff)</label>
          <select class="form-control textbox " id="exampleFormControlSelect1" name="staff_id">
      ...
      <div class="col-md-4 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="category_id">
      ...
      <div class="col-md-4 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="type_id">
      ...
      <div class="col-md-4 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="destribution_id">
    ...
    <div class="form-row">
      ...
      <div class="col-md-4 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="source">
      ...
      <div class="col-md-4 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="department_id">
      ...
      <div class="col-md-4 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="approval">
    ...
    <div class="form-row">
      ...
      <div class="col-md-3 mb-3">
        <div class="form-group">
          ...
          <select class="form-control textbox" id="exampleFormControlSelect1" name="ticket_type">
      ...
      <div class="col-md-3 mb-3">
        ...
        <input type="number" class="form-control textbox" id="validationDefault04" value="{{$model->ticket_counter}}" placeholder="Ticket Counter" name="ticket_counter">
      </div>
      <div class="col-md-3 mb-3">
        <div class="form-group">
          <label for="exampleFormControlSelect1">Priority</label>
          <select class="form-control textbox" id="exampleFormControlSelect1" name="priority_id">
