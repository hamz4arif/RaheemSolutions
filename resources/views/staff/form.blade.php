...
@csrf
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control inputbox" id="validationDefault01" placeholder="Staff Name" value="{{$model->name}}" name="name">
    </div>
    <div class="col-md-4 mb-3">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control inputbox" id="validationDefault04" value="{{$model->country}}" placeholder="Country" name="country" >
    </div>
    <div class="col-md-4 mb-3">
        <div class="form-group">
            <label for="exampleFormControlSelect1">Location</label>
            <select class="form-control mainselectbox" id="exampleFormControlSelect1" name="location">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control inputbox" id="validationDefault04" value="{{$model->mobile}}" placeholder="Mobile" name="mobile" >
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">Phone</label>
      <input type="text" class="form-control inputbox" id="validationDefault04" value="{{$model->phone}}" placeholder="Phone" name="phone" >
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">Phone Ext</label>
      <input type="text" class="form-control inputbox" id="validationDefault04" value="{{$model->phone_ext}}" placeholder="Phone Ext" name="phone_ext" >
    </div>
    <div class="col-md-4 mb-3">
        <div class="form-group">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control inputbox" id="validationDefault04" value="{{$model->address}}" placeholder="Address" name="address" >
    </div>
    <div class="col-md-4 mb-3">
        <div class="form-group">
  ...
  <a href="/staff/index" class="btn btn-primary">Back</a>
</form>