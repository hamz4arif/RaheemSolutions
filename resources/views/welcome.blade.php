...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .login-button {
                ...
                background-image: linear-gradient(-180deg, #FEBA38 0%, #DF3516 100%);
                box-shadow: 0 1rem 1.25rem 0 rgb(220 75 22 / 50%), 0 -0.25rem 1.5rem rgb(110 15 55) inset, 0 0.75rem 0.5rem rgb(255 255 255 / 40%) inset, 0 0.25rem 0.5rem 0 rgb(180 70 58) inset;
            }
    ...
    <body class="antialiased">
        <div id ="image-container" class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <!-- <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block"> -->
                    @auth
                        <!-- <a href="{{ url('/dashboard') }}" class="text-sm text-black-900 underline">Dashboard</a> -->
                    @else
                        <!-- <a href="{{ route('login') }}" class="text-sm text-black-900 underline">Login</a> -->

                        @if (Route::has('register'))
                            <!-- <a href="{{ route('register') }}" class="ml-4 text-sm text-black-900 underline">Register</a> -->
                        @endif
                    @endauth
                <!-- </div> -->
            @endif
                <div style ="position:absolute;top:150px;">
                    <a href="/" class="navbar-brand">
                        <img src="{{ asset('assets/img/RS.png') }}" alt="RS" style="height:110px;">
                    </a>    
                </div>
