...
@csrf
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control inputbox" id="validationDefault01" placeholder="SLA Name" value="{{$model->name}}" name="name">
    </div>
    <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control inputbox" id="validationDefault04" value="{{$model->time}}" placeholder="(hh:mm:ss)" name="time" >
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
        <div class="form-group">
            ...
            <select class="form-control mainselectbox" id="exampleFormControlSelect1" name="group">
    ...
    <div class="col-md-4 mb-3">
        <div class="form-group">
            ...
            <select class="form-control mainselectbox multi-select" id="exampleFormControlSelect1" name="location[]" multiple>
