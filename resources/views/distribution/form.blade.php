...
@csrf
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault01" placeholder="Distribution Name" value="{{$model->name}}" name="name"required>
    </div>
    <div class="col-md-4 mb-3">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->city}}" placeholder="City" name="city" required>
    </div>
    <div class="col-md-4 mb-3">
        <div class="form-group">
  ...
  <div class="form-row">
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->email_password}}" placeholder="Email Password" name="email_password" required>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationDefault04">Number</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->number}}" placeholder="Number" name="number" required>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationDefault04">Distributor ID</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->distributor_id}}" placeholder="Distributor ID" name="distributor_id" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">NPDMS Release</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->npdms_release}}" placeholder="NPDMS Release" name="npdms_release" required>
    </div>
    <div class="col-md-4 mb-3">
        <div class="form-group">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->kpo_name}}" placeholder="KPO" name="kpo_name" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">KPO Number</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->kpo_number}}" placeholder="KPO Number" name="kpo_number" required>
    </div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="number" class="form-control" id="validationDefault04" value="{{$model->business_class}}" placeholder="Business Class" name="business_class" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">System Count</label>
      <input type="number" class="form-control" id="validationDefault04" value="{{$model->system_count}}" placeholder="System Count" name="system_count" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">System CPU</label>
      <input type="number" class="form-control" id="validationDefault04" value="{{$model->system_cpu}}" placeholder="System CPU" name="system_cpu" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">System Ram</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->system_ram}}" placeholder="System Ram" name="system_ram" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">System HDD</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->system_hdd}}" placeholder="System HDD" name="system_hdd" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">Operating System</label>
      <input type="number" class="form-control" id="validationDefault04" value="{{$model->operating_system}}" placeholder="Operating System" name="operating_system" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">Android Device Count</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->android_device_count}}" placeholder="Android Device Count" name="android_device_count" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">Auto Pilot</label>
      <input type="text" class="form-control" id="validationDefault04" value="{{$model->auto_pilot}}" placeholder="Auto Pilot" name="auto_pilot" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationDefault04">New Release</label>
      <input type="number" class="form-control" id="validationDefault04" value="{{$model->new_release}}" placeholder="New Release" name="new_release" required>
    </div>
  </div>
